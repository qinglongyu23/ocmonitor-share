...
class ReportGenerator:
    ...
    def _get_model_breakdown_for_sessions(
        ...
        for session in sessions:
            for file in session.files:
                ...
                model_data[model]["cache_write_tokens"] += file.tokens.cache_write
                model_data[model]["cache_read_tokens"] += file.tokens.cache_read
                model_data[model]["total_tokens"] += file.tokens.total
    ...
    def _display_daily_breakdown_table(
        ...
        if breakdown:
            ...
            table.add_column("Sess.", justify="right", style="green")
            ...
            for day in daily_usage:
                ...
                for model_data in model_breakdown:
                    table.add_row(
                        ...
                        f"{model_data['cache_write_tokens']:,}",
                        f"{model_data['cache_read_tokens']:,}",
    ...
    def _display_weekly_breakdown_table(
        ...
        table.add_column("Date Range / Model", style="dim cyan", no_wrap=False)
        table.add_column("Sess.", justify="right", style="green")
        table.add_column("Int.", justify="right", style="green")
        table.add_column("Input", justify="right", style="blue")
        table.add_column("Output", justify="right", style="blue")
        ...
        for week in weekly_usage:
            ...
            table.add_row(
                ...
                f"{week.total_tokens.input:,}",
                f"{week.total_tokens.output:,}",
                f"{week.total_tokens.cache_write:,}",
                f"{week.total_tokens.cache_read:,}",
    ...
    def _display_monthly_breakdown_table(
        ...
        for month in monthly_usage:
            ...
            table.add_row(
                ...
                f"{month.total_tokens.input:,}",
                f"{month.total_tokens.output:,}",
                f"{month.total_tokens.cache_write:,}",
                f"{month.total_tokens.cache_read:,}",
